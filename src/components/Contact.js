    ...
    <section className="contact-portal" id="contact">
      <div className="container portal-wrapper">
        <div className="portal-content">
          <h4 className="detail-label" style={{ marginBottom: '10px' }}>PORTAL</h4>
          ...
          {!submitted ? (
            ...
            <div className="success-message">
              <div className="success-icon-circle">
                <svg viewBox="0 0 24 24" className="fly-jet"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z" fill="white" /></svg>
              </div>
              <h2 className="thank-you-text">Initiated!</h2>
              <p className="success-subtext">
                WhatsApp and Email drafts have been created.<br />
